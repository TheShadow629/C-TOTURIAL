//word 20
//Designing or coding classes in a minimal but complete manner means creating classes that
//have just enough functionality to fulfill their intended purpose, without including unnecessary
//or extraneous features.It involves keeping the class focused, cohesive, and reusable.
//
//To provide additional functionality to a class without creating additional methods or friends of the class,
//we can use the concept of "composition over inheritance" and leverage other existing classes or components.
//We can achieve this by using composition or by utilizing existing functions and libraries within our class.
//
...
//
//For example, we can define a namespace called `MyCalculator` to
//contain the `Calculator` class and any other related classes or functions :
//
...
//By using namespaces, we can avoid naming conflicts and organize our codebase more effectively,
//especially when dealing with larger projects or when collaborating with other developers.